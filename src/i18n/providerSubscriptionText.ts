...
export const PROVIDER_SUBSCRIPTION_TEXT = {
  es: {
    ...
    freeQuotaIntro: 'Incluye {dayRequests} solicitudes por día y hasta {monthRequests} solicitudes por mes.',
  ...
  en: {
    ...
    freeQuotaIntro: 'Includes {dayRequests} requests per day and up to {monthRequests} requests per month.',
