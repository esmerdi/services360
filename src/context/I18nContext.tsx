...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    clientRequestDetail: {
      ...
      providerLiveLocationTitle: 'Provider live location',
      providerLiveLocationActive: 'Live tracking is active while your provider is on the way or working on your request.',
      providerLiveLocationWaiting: 'Waiting for updated provider location. Ask the provider to enable GPS in the app.',
      providerLiveLocationUpdatedNow: 'Updated just now',
      providerLiveLocationUpdatedSeconds: 'Last update {{seconds}}s ago',
    ...
    landing: {
      ...
      plansTitle: 'Plans that fit your launch stage',
      plansSubtitle: 'Start providers on FREE with a monthly quota and scale with PRO when demand grows.',
      plansProvidersTab: 'Provider plans',
      plansClientsTab: 'Client access',
      planTrialLabel: 'FREE',
      planTrialPrice: '0 USD without expiration',
      planTrialDescription: 'Ideal to start with low risk while validating local demand.',
      planTrialFeatureDays: 'No expiration',
      planTrialFeatureRequests: '10 requests per 30-day period',
      planTrialFeatureMap: 'Area-based map visibility',
      planProLabel: 'PRO',
      planProPrice: '7.99 USD / month',
      planProDescription: 'For providers ready to scale visibility and request flow.',
      planProFeatureRequests: 'Unlimited requests per month',
      planProFeatureSearch: 'Featured in search',
      planProFeaturePriority: 'Priority support and profile boost',
      planClientTitle: 'Client access is free',
      planClientDescription: 'Clients can publish requests at no cost while provider coverage grows by zone.',
  ...
  es: {
    ...
    clientRequestDetail: {
      ...
      providerLiveLocationTitle: 'Ubicación del proveedor en vivo',
      providerLiveLocationActive: 'El seguimiento en vivo está activo mientras tu proveedor va en camino o trabaja en tu solicitud.',
      providerLiveLocationWaiting: 'Esperando ubicación actualizada del proveedor. Pídele que active el GPS en la app.',
      providerLiveLocationUpdatedNow: 'Actualizado ahora mismo',
      providerLiveLocationUpdatedSeconds: 'Última actualización hace {{seconds}} s',
      tabOverview: 'Resumen',
    ...
    landing: {
      ...
      plansTitle: 'Planes para tu etapa de lanzamiento',
      plansSubtitle: 'Comienza con FREE y su cupo mensual, y escala con PRO cuando la demanda por zona sea constante.',
      plansProvidersTab: 'Planes de proveedor',
      plansClientsTab: 'Acceso de cliente',
      planTrialLabel: 'FREE',
      planTrialPrice: '0 USD sin caducación',
      planTrialDescription: 'Ideal para iniciar con bajo riesgo mientras validas la demanda local.',
      planTrialFeatureDays: 'Sin caducación',
      planTrialFeatureRequests: '10 solicitudes por período de 30 días',
      planTrialFeatureMap: 'Visibilidad por zona en el mapa',
      planProLabel: 'PRO',
      planProPrice: '7.99 USD / mes',
      planProDescription: 'Para proveedores que quieren escalar visibilidad y flujo de solicitudes.',
      planProFeatureRequests: 'Solicitudes ilimitadas por mes',
      planProFeatureSearch: 'Destacado en búsqueda',
      planProFeaturePriority: 'Soporte prioritario e impulso de perfil',
      planClientTitle: 'El acceso para clientes es gratis',
      planClientDescription: 'Los clientes publican solicitudes sin costo mientras la cobertura de proveedores crece por zona.',
