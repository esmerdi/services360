...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    landing: {
      ...
      planTrialLabel: 'FREE',
      planTrialPrice: '0 USD / 30 days',
      planTrialDescription: 'Ideal to start with low risk while validating local demand.',
      planTrialFeatureDays: '30-day validity',
      planTrialFeatureRequests: '3 requests per day',
  ...
  es: {
    ...
    landing: {
      ...
      planTrialLabel: 'FREE',
      planTrialPrice: '0 USD / 30 días',
      planTrialDescription: 'Ideal para iniciar con bajo riesgo mientras validas la demanda local.',
      planTrialFeatureDays: 'Vigencia de 30 días',
      planTrialFeatureRequests: '3 solicitudes por día',
