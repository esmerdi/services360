...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    landing: {
      ...
      plansSubtitle: 'Start providers on trial and scale with PRO once they begin receiving steady demand.',
      plansProvidersTab: 'Provider plans',
      plansClientsTab: 'Client access',
      planTrialLabel: 'TRIAL',
      planTrialPrice: 'USD 0 for 15 days',
      planTrialDescription: 'Ideal to start with low risk while validating local demand.',
      planTrialFeatureDays: '15-day trial period',
      planTrialFeatureRequests: '10 requests per month',
  ...
  es: {
    ...
    landing: {
      ...
      plansSubtitle: 'Comienza con trial para proveedores y escala con PRO cuando la demanda por zona sea constante.',
      plansProvidersTab: 'Planes de proveedor',
      plansClientsTab: 'Acceso de cliente',
      planTrialLabel: 'TRIAL',
      planTrialPrice: 'USD 0 por 15 días',
      planTrialDescription: 'Ideal para iniciar con bajo riesgo mientras validas la demanda local.',
      planTrialFeatureDays: 'Periodo de prueba de 15 días',
      planTrialFeatureRequests: '10 solicitudes por mes',
