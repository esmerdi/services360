...
export const PROVIDER_SUBSCRIPTION_TEXT = {
  es: {
    ...
    current: 'Actual',
    free: 'Gratis',
    noExpiration: '/ 30 días',
    freeQuotaIntro: 'Cupo del plan FREE',
    freeQuotaValidity: 'Vigencia de {validityDays} días desde la activación.',
    freeQuotaDay: '{dayRequests} solicitudes por día',
    freeQuotaMonth: '{monthRequests} solicitudes por mes',
    monthShort: 'mes',
  ...
  en: {
    ...
    current: 'Current',
    free: 'Free',
    noExpiration: '/ 30 days',
    freeQuotaIntro: 'FREE plan quota',
    freeQuotaValidity: 'Valid for {validityDays} days from activation.',
    freeQuotaDay: '{dayRequests} requests per day',
    freeQuotaMonth: '{monthRequests} requests per month',
    monthShort: 'mo',
    selected: 'Selected',
